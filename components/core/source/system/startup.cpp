...
rcc_config_t rcc = {
	...
	.hclk_freq_mhz = CONFIG_CLK_HCLK_FREQ,
	.apb1_freq_mhz = CONFIG_CLK_APB1_FREQ,
	.apb2_freq_mhz = CONFIG_CLK_APB2_FREQ,
	.sdio_usb_freq_mhz = CONFIG_CLK_SDIO_USB_FREQ,
};
...
int main(void){
	...
	LOG_INFO(TAG, "Ram capacity  	 : %dKbytes",  CONFIG_MEM_IRAM_SIZE);
